 ...
 */
@Stateless
public class MSTGatewayTypeDAOImp implements MSTGatewayTypeDAO {
    ...
    public List<MSTGatewayTypes> findAll() {
        return entityManager.createNamedQuery("MSTGatewayTypes.findAll", MSTGatewayTypes.class).getResultList();
    }
