 ...
 */
@Stateless
public class MSTPremiseTypeDAOImp implements MSTPremiseTypeDAO {
    ...
    public List<MSTPremiseTypes> findAll() {
        return entityManager.createNamedQuery("MSTPremiseTypes.findAll", MSTPremiseTypes.class).getResultList();
    }
