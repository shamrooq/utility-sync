...
@Named(value = "installationViewController")
@ViewScoped
public class InstallationViewController implements Serializable  {
    
    private static final Logger LOGGER = Logger.getLogger(InstallationViewController.class);
