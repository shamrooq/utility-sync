 ...
 */
@Stateless
public class MSTDaisychainTypeDAOImp implements MSTDaisychainTypeDAO {
    ...
    public List<MSTDaisychainTypes> findAll() {
        return entityManager.createNamedQuery("MSTDaisychainTypes.findAll", MSTDaisychainTypes.class).getResultList();
    }
