...
import ae.etisalatdigital.iot.ops.utility.sync.buses.MSTDaisychainTypeBus;
...
@Named(value = "cablingViewController")
@SessionScoped
public class CabelingViewController implements Serializable  {
    
    private static final Logger LOGGER = Logger.getLogger(CabelingViewController.class);
    ...
    List<MSTDaisychainTypes> daisychainTypes;
    ...
    @Inject
    private MSTDaisychainTypeBus daisychainTypeBus;
    ...
    public List<MSTDaisychainTypes> getDaisychainTypes() {
        return daisychainTypes;
    }
    ...
    public void findAllDaisychainTypes(){
        daisychainTypes = daisychainTypeBus.findAll();
    }
