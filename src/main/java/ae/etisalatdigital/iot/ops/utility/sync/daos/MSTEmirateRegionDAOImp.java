 ...
 */
@Stateless
public class MSTEmirateRegionDAOImp implements MSTEmirateRegionDAO {
    ...
    public List<MSTEmirateRegions> findAll() {
        return entityManager.createNamedQuery("MSTEmirateRegions.findAll", MSTEmirateRegions.class).getResultList();
    }
