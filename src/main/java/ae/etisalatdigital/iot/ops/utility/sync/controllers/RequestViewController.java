...
@Named(value = "requestViewController")
@ViewScoped
public class RequestViewController implements Serializable  {
    
    private static final Logger LOGGER = Logger.getLogger(RequestViewController.class);
